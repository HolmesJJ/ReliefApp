...
public final class ChatUtils {
    ...
    public static List<Chat> getDefaultMenus() {
        return new Gson().fromJson(getDefaultMenuJson(ContextUtils.getContext()), new TypeToken<List<Chat>>() {
        }.getType());
    }

    public static String getDefaultMenuJson(Context context) {
        return getFileJson("chat.json", context);
    }
